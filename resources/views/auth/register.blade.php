        ...
        <div class="w-96 p-6 rounded-lg bg-blue-900 shadow-xl">
            ...
            <form method="POST" action="{{ route('register') }}" class="pt-8">
                ...
                <div class="relative">
                    ...
                    @if ($errors->has('name'))
                    <span class="text-red-600 text-xs" role="alert"><strong>{{ $errors->first('name') }}</strong></span>
                    @endif
                </div>
                ...
                <div class="relative pt-3">
                    ...
                    @if ($errors->has('email'))
                    <span class="text-red-600 text-xs" role="alert"><strong> {{ $errors->first('email') }} </strong></span>
                    @endif
                </div>
                ...
                <div class="relative pt-3">
                    ...
                    <span class="text-red-600 text-xs" role="alert"><strong>{{ $errors->first('password') }}</strong></span>
                    @endif
                </div>
