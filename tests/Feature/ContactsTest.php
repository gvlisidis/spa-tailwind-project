...
class ContactsTest extends TestCase
{
    ...
    public function an_authenticated_user_can_add_a_contact()
    {
        ...
        $this->assertEquals('04/06/1980', $contact->birthday->format('m/d/Y'));
        $this->assertEquals('ABC Netsells', $contact->company);
    ...
    public function birthdays_are_properly_stored()
    {
        ...
        $this->assertEquals('04/06/1980', Contact::first()->birthday->format('m/d/Y'));
    }
